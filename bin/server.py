...
# This module is based on FIRtro, a preamp and digital crossover
...
if __name__ == "__main__":
    ...
    address = misc.CONFIG[f'server_addr']
    port    = misc.CONFIG[f'server_port']
    
    try:
        processing = __import__(service)
        print( f'(server.py) running \'{service}\'' )
        run_server( host=address, port=port, verbose=verbose )

    except:
        print( f'(server.py) stopped. Bye' )
